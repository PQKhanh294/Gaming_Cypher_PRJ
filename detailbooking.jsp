...
<div class="container">
    <h3 class="text-center mb-4"><i class="fas fa-desktop"></i> DetailBooking</h3>
    ...
    <form action="BookingServlet" method="post">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="computerID" required>
                <c:forEach var="i" begin="1" end="12">
                    <option value="Computer ${i}">Computer ${i}</option>
                </c:forEach>
            </select>
        </div>
        ...
        <!-- Nút submit -->
        <button type="submit" class="btn btn-submit"><i class="fas fa-check"></i> Submit Booking</button>
    </form>
</div>
